...
**Sequential panel debates.** When you prompt Z with a complex query touching multiple domains (e.g., balancing workload stress and physical deloads with dietary choices in your personal life, or aligning sprint deliverables and financial budgets with content marketing strategies in a business project), the system triggers a collaborative panel debate among the relevant experts. The panel operates in a strict, sequenced priority chain:
1. **Domain Experts** (e.g., health, fitness, chef in personal; market-intel, legal, content in business) run first, drafting their respective domain plans independently.
2. **Focus** (Clarity & Priority Synthesizer) runs next, reviewing the drafts, evaluating conflict points, checking your actual calendar/mood levels, and resolving contradictions to establish a singular focus plan. It achieves this by mapping proposed tasks to your long-term goals, triaging them against your daily biological and calendar capacity, and using a strict veto/leverage override (e.g., biological recovery always vetoes high physical exertion, and immediate legal deadlines down-scale non-urgent tasks) to output one cohesive focus strategy.
...
**Dynamic round scaling.** If Focus detects a critical contradiction or safety/burnout veto that remains unresolved after the initial rebuttal round (e.g., fitness proposing hard training despite a severe stress deload veto from health, or legal insisting on an immediate contract review that conflicts with critical sprint deliverables), it dynamically triggers a third **Reconciliation Round**. The conflicting crews are adaptively queried to resolve the conflict safely under Focus's guidance, ensuring Z's final Executive Synthesis is perfectly aligned, cohesive, and safe.
