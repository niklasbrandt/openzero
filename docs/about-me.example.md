...
>
> **Copy this file to `personal/about-me.md` and fill in your details.**
> The `personal/` folder is gitignored — your data stays private.
...
- <!-- What drives you? -->
- <!-- What does the agent need to understand about how you think? -->
...
<!-- Be honest. The agent uses this to push you in the right direction. -->

- <!-- e.g., consistency with health habits -->
- <!-- e.g., networking / outreach for job search -->
