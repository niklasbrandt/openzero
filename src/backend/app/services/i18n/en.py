...
translations: dict[str, str] = {
	...
	"tip_bench_instant": "Benchmark the instant tier (~3-4B model). Used for quick greetings and confirmations.",
	...
	"tip_instant": "Lightweight 0.6B model for quick greetings, confirmations, and trivial Q&A.",
