...
- Create Task: `[ACTION: CREATE_TASK | BOARD: name | LIST: name | TITLE: text | DESCRIPTION: full content]`
  ...
  DESCRIPTION is REQUIRED for any task with substantive content (recipes, instructions, notes). Paste the full text directly inside the tag — multi-line content is supported and the description ends at the closing ]. NEVER put a full recipe or set of instructions outside the tag and leave DESCRIPTION empty.
