		...
		"tiers": [
			{
				...
				"ctx": int(os.environ.get("LLM_INSTANT_CTX", "0")),
				"batch": int(os.environ.get("LLM_INSTANT_BATCH", "0")),
				"predict": int(os.environ.get("LLM_INSTANT_PREDICT", "0")),
			...
			},
			{
				...
				"ctx": int(os.environ.get("LLM_DEEP_CTX", "0")),
				"batch": int(os.environ.get("LLM_DEEP_BATCH", "0")),
				"predict": int(os.environ.get("LLM_DEEP_PREDICT", "0")),
